module github.com/cloudnative-pg/cnpg-i-hello-world
...
require (
	...
	github.com/cloudnative-pg/cnpg-i 7522ca3c5ff5
	github.com/cloudnative-pg/cnpg-i-machinery 8e699460292f
