...
`cnpg-i-hello-world` is a component of the **Extensibility** subproject of
CloudNativePG (see `subprojects/extensibility.md` in
...
repository through the `cnpg-i-hello-world-owners` GitHub team, and are its default
